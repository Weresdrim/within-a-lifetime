...
init -1 python hide:
    ...
    config.window_title = u"Within a Lifetime"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "TimeGrills"
    config.version = "1.0"
    ...
    style.window.background = Frame("#0000007f", 24, 12)
...
python early:
    config.save_directory = "TimeGrills-1431127992"
...
init python:
    ...
    build.directory_name = "TimeGrills-1.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Within a Lifetime"
